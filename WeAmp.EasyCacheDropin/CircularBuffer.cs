...
namespace WeAmp.ScriptableCacheModule
{
    ...
    public class CircularBuffer<T> : ICollection<T>, IEnumerable<T>, ICollection, IEnumerable
    {
        ...
        {
            if (capacity < 0)
                throw new ArgumentException("CircularBuffer cannot be instantiated with zero capacity", "capacity");
        ...
        public int Capacity
        {
            ...
            set
            {
                ...
                if (value < size)
                    throw new ArgumentOutOfRangeException("value", "Circular Buffer Capacity too small");
        ...
        public void Put(T item)
        {
            if (!AllowOverflow && size == capacity)
                throw new InvalidOperationException("Circular buffer message overflow");
        ...
        {
            if (count > size)
                throw new ArgumentOutOfRangeException("count", "Message read count too large");
